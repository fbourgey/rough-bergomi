...
class RoughBergomi(ForwardVarianceModel):
    ...
    params : dict
        Dictionary containing model parameters: 'H' (Hurst parameter, must be positive)
        and 'eta' (volatility of volatility, must be positive).
    s0 : float, optional
        Initial spot price (must be positive). Default is 1.0.
    name : str, optional
        Name identifier for the model. Default is 'rough_bergomi'.
